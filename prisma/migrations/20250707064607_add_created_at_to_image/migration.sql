...
INSERT INTO "new_images" ("category", "city", "country", "filename", "hash", "height", "id", "isCombined", "isCover", "isFavorite", "latitude", "longitude", "memoryId", "metadata", "mimeType", "momentId", "originalName", "path", "size", "thumbnailPath", "thumbnails", "userId", "width") SELECT "category", "city", "country", "filename", "hash", "height", "id", "isCombined", "isCover", "isFavorite", "latitude", "longitude", "memoryId", "metadata", "mimeType", "momentId", "originalName", "path", "size", "thumbnailPath", "thumbnails", "userId", "width" FROM "images";
DROP TABLE "images";
